  ...
  questions: [
    {
      ...
      incorrect:
        "<p><span>wrong</span> It's wrong,</br> Ans: 2 x force on flat plate</p>", // no comma here
    },
    {
    ...
    },
    {
      ...
      a: [
        {
          option: "Force on a vertical projection of the curved surface ",
          correct: true,
        },
        {
          option: "Weight of liquid vertically below the curved surface",
          correct: false,
        },
        {
          option: "Product of pressure at its centroid and the area ",
          correct: false,
        },
        {
          option: "Weight of liquid retained by the curved area.",
          correct: false,
        }, // no comma here
      ],
      correct: "<p><span>Right answer</span> </p>",
      incorrect:
        "<p><span>wrong</span> It's wrong,</br> Ans: Weight of liquid retained by the curved area.</p>", // no comma here
    },
    {
